...
export const siteConfig = pgTable("site_config", {
  ...
  aboutMediaUrl: text("about_media_url"),
  ctaMediaUrl: text("cta_media_url"),
  contactMediaUrl: text("contact_media_url"),
  departmentMediaUrls: jsonb("department_media_urls").$type<string[]>().default([]),
  testimonialMediaUrls: jsonb("testimonial_media_urls").$type<string[]>().default([]),
